...
if((trial.monotonic_pallette == "red" & category == "Mono") | (trial.monotonic_pallette == "blue" & category != "Mono")){
  var colour_array = jsPsych.randomization.repeat(["red", "green", "blue", "yellow"], trial.colour_prob, false)
}

if((trial.monotonic_pallette == "blue" & category == "Mono") | (trial.monotonic_pallette == "red" & category != "Mono")){
  var colour_array = jsPsych.randomization.repeat(["yellow", "blue", "green", "red"], trial.colour_prob, false)
}
...
rows.style.border = trial.grid_border;
          ...
          const end_trial = () => {
              ...
              // Score the trial
              trial.accuracy = 0;
              if(trial.choices[response.button] == trial.monotonic_label & trial.category == "Mono"){trial.accuracy = 1}
              if(trial.choices[response.button] != trial.monotonic_label & trial.category != "Mono"){trial.accuracy = 1}
