var jsPsychHtmlButtonResponse = (function (jspsych) {
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          html += "<span style = 'color: transparent; font-size: 100px;'>|<span>";
          for (var i = 0; i < trial.choices.length; i++) {
              var str = buttons[i].replace(/%choice%/g, trial.choices[i]);
              if(i == 1 & trial.choices.length == 4) {html +=
                  '<div class="jspsych-html-buton-response-button" style="display: inline-block; margin:' +
                      ...
                      str +
                      "</div>" +
                      "<span style = 'color: black; font-size: 100px;'>|<span>"; 
                    }

                    else if(i == 0 & trial.choices.length == 2) {html +=
                  '<div class="jspsych-html-buton-response-button" style="display: inline-block; margin:' +
                      trial.margin_vertical +
                      " " +
                      trial.margin_horizontal +
